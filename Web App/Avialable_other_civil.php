...
if (isset($_POST['ignore'])) {
	...
	if($rund){
			echo '<script type="text/javascript">';
    	   	  	   ...
    	   	  	   echo 'window.location.href="Avialable_other_civil.php"';
    	   	  	   echo '</script>';
	}
	}
...
if (isset($_POST['start_track'])) {
	$id=$_POST['id'];
		$sqlw="update other_civil set status=2 where case_id='$id'";
...
if(isset($_POST['upload'])){
	...
	$size=$_FILES['file']['size'];
		...
		if(move_uploaded_file($file, $destination)){
			$sq="insert into files(file_name,size,download,status) values('$filename.','$size',0,5)";
...
<div class="container">
    ...
    <label for="delet" class="close_btn" title="close">&times;</label>
     <h1>Delete Case</h1>
    <form class="delete" action="Avialable_other_civil.php" method="post">
  ...
  <div class="container3">
    ...
    <label for="upload" class="close_btn" title="close">&times;</label>
     <h1>Upload File</h1>
    	<form class="delete" action="Avialable_other_civil.php" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
		...
		if($data->num_rows >0){
			?>
			<h1>Avialable Other Civil Cases</h1>
			<?php
...
<input type="checkbox" id="start">
  ...
  <label for="upload" class="show_btn">Upload File</label>
    <br>
    <a href="register_other.php">Add New</a></br>
    	<a href="register_other.php">Edit</a>
                 ...
                 {
                 echo'<h1 class="no"><strong>No Avialable Other Civil Cases</strong></h1>';
                 ?>
...
<input type="checkbox" id="start">
  ...
  <label for="upload" class="show_btn">Upload File</label>
    <br>
    <a href="register_other.php">Add New</br></a>
    	<a href="register_other.php">Edit</a>
    </td></tr>
</table>
    	<?php
    		 ...
    		 $sqll="select *from files where status=5";
