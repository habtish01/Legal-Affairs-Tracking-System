...
if(isset($_POST['upload'])){
	...
	$size=$_FILES['file']['size'];
		...
		if(move_uploaded_file($file, $destination)){
			$sq="insert into files(file_name,size,download,status) values('$filename.','$size',0,16)";
...
<body>
    ...
    <div class="content">
    	<div class="content_left">
    		<h3>Laws  Of Legal Tracking Affairs </h3>
    		<div class="fileform">
    			<h1>Upload Your File</h1>
    		<form action="law.php" method="post" enctype="multipart/form-data">
              ...
              <?php
               $sqll="select *from files where status=16";
