...
$sql="select *from consulancy where status=3";
...
if (isset($_POST['ignore'])) {
	...
	if($run){
		echo '<script type="text/javascript">';
    	   	  	   ...
    	   	  	   echo 'window.location.href="consulancy_module.php"';
    	   	  	   echo '</script>';
	}
}
if(isset($_POST['upload'])){
	...
	$size=$_FILES['file']['size'];
		...
		if(move_uploaded_file($file, $destination)){
			$sq="insert into files(file_name,size,download,status) values('$filename.','$size',0,13)";
...
<head>
	<meta charset="utf-8">
	<title>This Is Consultancy Module Page</title>
...
<div class="container">
    ...
    <label for="delet" class="close_btn" title="close">&times;</label>
     <h1>Delete Case</h1>
    <form class="delete" action="consulancy_module.php" method="post">
  ...
  <div class="container3">
    ...
    <label for="upload" class="close_btn" title="close">&times;</label>
     <h1>Upload File</h1>
    	<form class="delete" action="consulancy_module.php" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
		...
		if($data->num_rows >0){
			?>
			<h1><strong>Avialable Dead Consultancy Cases</strong></h1>
			<?php
  ...
  <label for="upload" class="show_btn">Upload File</label>
   <br>
    	<a href="consulancy_register.php">Edit</a>
                 ...
                 echo'<h1 class="no"><strong>No Avialable Dead Consultancy Cases</strong></h1>';
                    ?>
  ...
  <label for="upload" class="show_btn">Upload File</label>
    	...
    	<?php
                 ...
                 ?>
                  ...
                  <?php
    		  $sqll="select *from files where status=13";
