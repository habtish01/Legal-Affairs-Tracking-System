...
$sql="select *from human_resource where status=1";
...
if (isset($_POST['ignore'])) {
	...
	if($rund){
			echo '<script type="text/javascript">';
    	   	  	   ...
    	   	  	   echo 'window.location.href="Avialable_H_resource.php"';
    	   	  	   echo '</script>';
	}
	}
...
if (isset($_POST['start_track'])) {
	$id=$_POST['id'];
		$sqlw="update human_resource set status=2 where case_id='$id'";
...
if(isset($_POST['upload'])){
	...
	$size=$_FILES['file']['size'];
		...
		if(move_uploaded_file($file, $destination)){
			$sq="insert into files(file_name,size,download,status) values('$filename.','$size',0,4)";
...
<head>
	<meta charset="utf-8">
	<title>This Is Avialable Civil Cases Page</title>
...
<div class="container">
    ...
    <label for="delet" class="close_btn" title="close">&times;</label>
     <h1>Delete Case</h1>
    <form class="delete" action="Avialable_H_resource.php" method="post">
  ...
  <div class="container3">
    ...
    <label for="upload" class="close_btn" title="close">&times;</label>
     <h1>Upload File</h1>
    	<form class="delete" action="Avialable_H_resource.php" method="post" enctype="multipart/form-data">
...
<input type="checkbox" id="start">
  ...
  <label for="upload" class="show_btn">Upload File</label>
    <br>
    <a href="register_civil.php">Add New</a></br>
    	<a href="register_civil.php">Edit</a>
                 ...
                 {
                 echo'<h1 class="no"><strong>No Avialable Civil Cases</strong></h1>';
                 ?>
...
<input type="checkbox" id="start">
  ...
  <label for="upload" class="show_btn">Upload File</label>
    <br>
    <a href="register_civil.php">Add New</br></a>
    	<a href="register_civil.php">Edit</a>
    </td></tr>
</table>
    	<?php
    		 ...
    		 $sqll="select *from files where status=4";
