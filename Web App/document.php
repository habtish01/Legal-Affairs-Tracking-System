...
if(isset($_POST['upload'])){
	...
	$size=$_FILES['file']['size'];
		...
		if(move_uploaded_file($file, $destination)){
			$sq="insert into files(file_name,size,download,status) values('$filename.','$size',0,18)";
...
<body>
    ...
    <div class="content">
    	<div class="content_left">
    		<h3>Documents Of Legal Tracking Affairs </h3>
    		<div class="fileform">
    		...
    		<form action="document.php" method="post" enctype="multipart/form-data">
              ...
              <?php
               $sqll="select *from files where status=18";
